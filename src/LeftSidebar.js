...
function Left_sidebar({user}) {
    ...
    return (
        <div>
            ...
            {user?.displayName?(
                uploadOpen && <UploadScreen setOpen={setUploadOpen} username={user.displayName}/>
            ):(
