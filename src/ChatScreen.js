...
function ChatScreen({ handleChatScreen }) {
  return (
    <div className="chat">
      <div className="chat__box">
        <div className="chat__header" >
          <svg onClick={handleChatScreen} aria-label="Back" className="back_svg" fill="#262626" height="24" viewBox="0 0 48 48" width="24"><path d="M40 33.5c-.4 0-.8-.1-1.1-.4L24 18.1l-14.9 15c-.6.6-1.5.6-2.1 0s-.6-1.5 0-2.1l16-16c.6-.6 1.5-.6 2.1 0l16 16c.6.6.6 1.5 0 2.1-.3.3-.7.4-1.1.4z"></path></svg>
          <h4>username</h4>
        ...
        <form className="chat__form">
          <input className="chat__input" type="text" placeholder="Message..."/>
